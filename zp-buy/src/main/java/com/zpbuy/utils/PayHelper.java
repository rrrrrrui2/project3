package com.zpbuy.utils;

import com.github.wxpay.sdk.WXPay;
import com.zpbuy.config.PayConfig;
import com.zpbuy.order.service.OrderService;
...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId) {
        ...
        try {
            String url = this.redisTemplate.opsForValue().get(key).toString();
        ...
        try {
            ...
            if ("SUCCESS".equals(result.get("return_code"))) {
                ...
                // 将付款地址缓存，时间为10分钟
                try {
                    this.redisTemplate.opsForValue().set(key, url, 10);
                } catch (Exception e) {
